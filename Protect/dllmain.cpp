...
#define CodeLength 38112
#define AssemblySize 120320

#define AntiDumpDef 1
#define MethodEncryptionDef 1
#define CRC32CheckDef 1
#define CRC32 2886772530
...
extern "C" __declspec(dllexport) bool _stdcall Protect64() {//void(__stdcall *antidump)()
	...
	*mdHdr = 0;
	...
	uint8_t iv[] = { 0xD8,0X2F,0XFE,0X67,0X8C,0XF5,0X11,0XAF,0X8C,0XE3,0X74,0X3B,0X91,0X38,0X94,0X71 };
	uint8_t key[] = { 0x83,0X78,0X0A,0X6A,0X64,0X8B,0XF5,0X76,0X69,0XAB,0X33,0X2B,0X99,0XB9,0XAC,0X9F,0XBE,0XA1,0XC9,0X47,0X8A,0XAD,0X15,0X3D,0XF9,0X38,0X5E,0XBD,0XAA,0X7D,0X75,0XE4 };
	AES_ctx ctx;
	...
	VirtualProtect((LPVOID)(module_ptr + 8192), sizeof(BYTEs), old, &old);
#endif
